...
from models.inpainting.comodgan.op import FusedLeakyReLU, fused_leaky_relu, upfirdn2d
from models.inpainting.comodgan.stylegan2 import PixelNorm, EqualLinear, EqualConv2d,ConvLayer,StyledConv,ToRGB,ConvToRGB,TransConvLayer
import numpy as np

from models.inpainting.comodgan.base_network import BaseNetwork
...
class CoModGANGenerator(BaseNetwork):
    def __init__(
            self,
...
class CoModGANDisc(BaseNetwork):
    def __init__(
            self,
            resolution
    ):
